...
| TD-003 | AdSense suspenso | Falta CMP certificada/IAB TCF em produção | Trust Platform | Alta | Configurar CMP, validar strings TCF e só então ativar o interlock |
